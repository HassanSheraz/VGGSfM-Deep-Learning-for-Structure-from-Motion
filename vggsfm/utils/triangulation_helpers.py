...
try:
    ...
    pyceres = None
    print("Warning: pyceres is not installed. Skipping pyceres-based optimization.")
...
def prepare_ba_options():
    if pyceres is not None:
        ...
        print("Warning: pyceres is not installed. Bundle adjustment options will not be used.")
        return None
